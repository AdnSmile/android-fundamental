...
import com.vvwxx.bangkit.mysharedpreferences.databinding.ActivityFormUserPreferenceBinding
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun saveUser(name: String, email: String, age: String, phoneNo: String, isLove: Boolean) {
