package com.vvwxx.bangkit.mysharedpreferences
...
import com.vvwxx.bangkit.mysharedpreferences.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun populateView(userModel: UserModel) {
        binding.tvName.text = if (userModel.name.toString().isEmpty()) "Tida Ada" else userModel.name
        binding.tvAge.text = if (userModel.age.toString().isEmpty()) "Tida Ada" else userModel.age.toString()
