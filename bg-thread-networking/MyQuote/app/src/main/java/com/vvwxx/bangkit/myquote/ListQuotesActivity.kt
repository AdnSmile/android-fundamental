...
import com.vvwxx.bangkit.myquote.databinding.ActivityListQuotesBinding
    ...
    private fun getListQuotes() {
        ...
        client.get(url, object: AsyncHttpResponseHandler() {
            override fun onSuccess(
                ...
                Log.d(TAG, result)
                try {
                    val jsonArray = JSONArray(result) // mengambil data json array
                    ...
                    // masukan semua data json dalam bentuk ArrayList ke recycle view
